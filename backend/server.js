...
async function seedDatabase() {
  try {
    ...
    if (bookCount === 0) {
      console.log(
        "La colección de libros está vacía. Sembrando datos iniciales..."
      );
      ...
      const initialBooks = [
        // Ficción
        {
          ...
          isDiscounted: true,
          description:
            "Una emocionante narrativa sobre el poder del cambio y la resiliencia.",
          rating: 4.8,
        ...
        },
        {
          ...
          isDiscounted: false,
          description:
            "Una colección de cuentos mágicos para leer al caer la noche.",
          rating: 4.6,
        ...
        },
        {
          ...
          isDiscounted: false,
          description:
            "Un viaje a un mundo perdido lleno de aventuras y desafíos.",
          rating: 4.7,
        ...
        },
        {
          ...
          rating: 4.3,
          deliveryTime: "3-4 días hábiles",
          comments: [{ user: "Ana", text: "Fascinante, muy bien explicado." }],
        ...
        // Aventura
        {
          ...
          isDiscounted: true,
          description:
            "La clásica historia de piratas y aventuras inolvidables.",
          rating: 4.8,
          deliveryTime: "2-3 días hábiles",
          comments: [
            {
        ...
        },
        {
          ...
          isDiscounted: false,
          description:
            "Un relato de exploración y superación en terrenos desconocidos.",
          rating: 4.7,
          deliveryTime: "2-3 días hábiles",
          comments: [
            {
        ...
        },
        {
          ...
          isDiscounted: true,
          description:
            "Una travesía a través de los ríos más enigmáticos del mundo.",
          rating: 4.6,
          deliveryTime: "3-4 días hábiles",
          comments: [
            {
        ...
        },
        {
          ...
          comments: [
            {
              user: "Luis",
              text: "Un libro que cambia la forma en que ves la biología.",
            },
          ],
        ...
        },
        {
          ...
          isDiscounted: true,
          description:
            "Un estudio sobre la evolución de la humanidad a lo largo de los siglos.",
          rating: 4.8,
          deliveryTime: "2-3 días hábiles",
          comments: [
            {
              user: "Andrés",
              text: "Muy educativo, me ayudó a entender mejor nuestra historia.",
            },
          ],
      ...
      console.log(
        `Se sembraron ${insertedBooks.length} libros en la base de datos.`
      );
      ...
      console.log(
        `La base de datos ya contiene ${bookCount} libros. No se sembrarán datos iniciales.`
      );
    }
  } catch (err) {
...
app.listen(PORT, () =>
  console.log(
    `🚀 Servidor corriendo en el puerto http://SocialBKLand.com:${PORT}`
  )
);
